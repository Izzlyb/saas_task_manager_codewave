...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('TODO', 'ASSIGNED', 'IN_PROGRESS', 'ON_HOLD', 'COMPLETED', 'BACKLOGGED', 'IN_REVIEW');
...
-- CreateEnum
CREATE TYPE "FileType" AS ENUM ('IMAGE', 'PDF', 'SPREADSHEET', 'PRESENTATION');
